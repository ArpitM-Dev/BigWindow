<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pages.aspx.cs" Inherits="storeSocial.pages" MasterPageFile="~/main.Master" %>
<asp:Content runat="server" ContentPlaceHolderID="cpMainBody" ID="cpMainbody">
        <div class="col-xs-7 homeBody">
            ...
            <div class="row"><div class="homeData" style="min-height:790px;">
